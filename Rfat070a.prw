...
User Function Rfat070a()        // incluido pelo assistente de conversao do AP5 IDE em 26/02/02
...
while !eof()
   ...
   If Alltrim(SE1->E1_PORTADO) == "920"  .or. Alltrim(SE1->E1_PORTADO) == "930"  .or. Alltrim(SE1->E1_PORTADO) == "904" //20041014
       dbSelectArea("SE1")
       dbSkip()
       Loop
   Endif
