...
±±ºPrograma  ³PFin017   ºAutor  ³Danilo C S Pala     º Data ³  20041122   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³Nova versao do programa de recebimentos por Stored Procedureº±±
±±º          ³   														  º±±
...
@ 010,010 SAY "Visualiza os relatorios já emitidos."
