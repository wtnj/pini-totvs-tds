...
User Function Rfat086()        // incluido pelo assistente de conversao do AP5 IDE em 26/02/02
...
DO WHILE .NOT. EOF()
   INCREGUA()
   IF SE1->E1_EMISSAO>CTOD('31/10/2000').AND. SE1->E1_GRPROD=='SOFT'
      DBSKIP()
      LOOP
   ENDIF
...
DO WHILE .NOT. EOF()
   ...
   IF MVEND <> ' '
      IF MVEND <> CODVEND
         @ L,69   SAY '----------'
         @ L+1,50 SAY 'TOTAL .......'
         @ L+1,67 SAY MSUBT PICTURE "@E 9,999,999.99"
         MSUBT:=0
         L:=60
      ENDIF
   ENDIF
   ...
   @ L,53 SAY NUMNF
   @ L,66 SAY PARCELA
   @ L,69 SAY VALOR PICTURE "@E 999,999.99"
   @ L,84 SAY VENCTO
...
L:=L+1
@ L,50 SAY 'TOTAL .......'
@ L,67 SAY MSUBT PICTURE "@E 9,999,999.99"
