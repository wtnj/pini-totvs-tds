...
WHILE !EOF() 
	...
	cTexto1 := "Recebemos da empresa "+ Alltrim(cNome)+". Sito à  "+ alltrim(cEnd) +" - "+ alltrim(cMun) +" / "+ alltrim(cEst) + ", "+ cCGC +" , à importância de  "+ cPreco + " ("+ EXTENSO(RECIBO->E1_VALOR) +")" + ", correspondente ao pagamento de "+ cPRODUTOS +". Título "+ RECIBO->E1_PREFIXO + RECIBO->E1_NUM + RECIBO->E1_PARCELA + " "
	...
	nLinha := nLinha + nSomaLinha
	oPrn:Say(nLinha, nColuna, ("Sito à  "+ alltrim(cEnd) +" - "+ alltrim(cMun) +" / "+ alltrim(cEst) ),oFont1,100)
	nLinha := nLinha + nSomaLinha
	oPrn:Say(nLinha, nColuna, (", "+ cCGC +" , à importância de  "+ cPreco) ,oFont1,100)
	nLinha := nLinha + nSomaLinha
	...
	*/
	...
	nLinha := nLinha + nSomaLinha
	oPrn:Say(nLinha, nColuna +340, ("Bom Retiro -  São Paulo/SP   01130-900") ,oFont1,100)
	nLinha := nLinha + nSomaLinha
