...
ฑฑบPrograma  ณPFat160   บAutor  ณDanilo C S Pala     บ Data ณ  20030915   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Programa para otimizacao do Pfat106C, com query 			  บฑฑ
ฑฑบ          ณ  (Clientes Cont/Arq)										  บฑฑ
...
///* teste 20030916
cQuerySZJ := "SELECT distinct zj_codrev, zj_edicao, zj_dtcirc FROM szj010 where zj_dtcirc >= '"+ dTOS(MV_PAR03) +"' and zj_dtcirc <'"+ dTOS(MV_PAR04) +"' and zj_codrev>='"+ Substr(MV_PAR01,1,4) +"' and zj_codrev<='"+ Substr(MV_PAR02,1,4) +"' and d_e_l_e_t_ <>'*'" //20031120
