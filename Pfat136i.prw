...
±±³Programa: PFAT136I  ³Autor: Raquel Ramalho         ³ Data:   28/08/01 ³ ±±
±±ÃÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´ ±±
±±³Descri‡Æo: Atualiza‡Æo da Edsusp p/ registro inadimpl na conversÆo    ³ ±±
...
Do While .T.
   ...
   Do While !Eof()
      ...
      If found()
         Mdtvenc:=ZJ_DTCIRC
      Else
        Alert("NÆo localizou no cronograma"+mprod+str(medvenc,4))
        Alert("NÆo localizou no cronograma"+mPedido+mItem)
         ...
         DO WHILE ZC6->C6_NUM+ZC6->C6_ITEMPANT==MPEDIDO+MITEM
            ...
            If found()
               ...
               If found()
                  mDtinic:=ZJ_DTCIRC
               Else
                 Alert("NÆo localizou no cronograma"+mProdatu+Str(mEdin,4))
                 Alert("NÆo localizou no cronograma"+mChave2)
                 Alert("Atualize cronograma antes de reiniciar o processo")
               Endif
               If mProd=='0108'
                  ...
                  Endif
               Else
                  mDtsusp:=mDtinic+mPer2  // atualiza o pedido pelo per¡odo em dias (deduz per¡odo j  recebido).
               Endif
               ...
               If mProd<>'0108'
                  ...
                  Else
                     Medsusp:=0
                     Alert("NÆo localizou no cronograma"+mProdatu+Dtoc(mDtsusp))
                     Alert("NÆo localizou no cronograma"+mChave2)
                     Alert("Atualize cronograma antes de reiniciar o processo")
                  Endif
               Endif
            ...
            Else
               mAtualiza:='N'
               Alert("NÆo atualizou pedido"+mChave2)
   ...
   FErase(_cString)
   If mConta==mConta3
      Alert("NÆo ‚ necess rio rodar este programa. Avise CPD p/ verifica‡Æo")
      Alert("Todos os t¡tulos venceram a mais de 90 dias")
   Endif
ENDDO
