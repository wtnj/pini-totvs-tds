...
/*/ alterado 20030908 por Danilo C S Pala
...
SetPrvt("XCEP_CLI,XCOB_CLI,XCOB_BAI,XCOB_CID,XCOB_EST,XCOB_CEP")
...
@ _nLin05,002  PSAY xEND_CLI                                 // Endereco
@ _nLin05,054  PSAY xBAIRRO                                  // Bairro
...
For BB := 7 to Len(xVALOR_DUP)
	IF  xPARC_DUP[BB] $ "G/H/I/J"
