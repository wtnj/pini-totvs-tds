...
User Function Pfin007()        // incluido pelo assistente de conversao do AP5 IDE em 26/02/02
...
±±³Funcao    ³ PFIN007  ³ Autor ³ Andreia Silva         ³ Data ³ 28/02/00 ³±±
...
±±³          ³ Somente p/ Vd. Mercantil,pois considera o E1_CODPORT e nÆo ³±±
±±³          ³ o E1_PORTADO                                               ³±±
...
±±³Alteracoes³ Alterado para voltar a usar o campo E1_  ³ Data ³ 03/07/01 ³±±
±±³          ³ PORTADO conf. Solicitacao da Srta. Tati- ³      ³          ³±±
±±³          ³ ana                                      ³      ³          ³±±
...
cString  := "SE1"
MHORA      := TIME()
wnRel    := "PFIN007_" + SUBS(CUSUARIO,7,3)+SUBS(MHORA,1,2)+SUBS(MHORA,7,2)
Tamanho  := "M"
Titulo   := "Titulos a Receber - Espec.Editora Pini Ltda"
cDesc1   := SPACE(02)+"Este programa imprimira somente titulos a receber, de acordo com os" 
cDesc2   := SPACE(08)+"parametros solicitados pelo usuario - Venda Mercantil"
cDesc3   := " "
...
While !Eof()
   ...
   //ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
   //³ Seleciona para impressao E1_CODPORT, conforme solicita‡Æo da ³
   //³ Editora Pini Ltda.                                           ³
   //ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
