...
User Function M241bar()        // incluido pelo assistente de conversao do AP5 IDE em 13/03/02
...
SetPrvt("_LAGLUTINA,AHEADER,")


/*
Este rdmake ‚ utilizado para atualizar as variaveis na rotina de codigo de barras
ref ao mata241.prx
As Variaveis PRIVATE que voce tem acesso sƒo:
aHeader      -> Cabe‡alho da coluna
_oB          -> "Objeto TBrowser"
