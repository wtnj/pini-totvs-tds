...
Alterado por Danilo C S Pala em 20121030: nao atualizar endereco se for cliente publicidade (Cidinha)
Alterado por Danilo C S Pala em 20130821: kit = aguarda defini็ใo deste processo 
ÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณJOBPINI01 บAutor  ณDanilo C S Pala     บ Data ณ  20100728   บฑฑ
...
If cSemaforo == "T"
	...
	cQuery := "SELECT idPedido, codUsuario, codEmpresa, numPedido, to_char(dataPedido,'yyyyMMdd') as dataPedido, codClientePini, codClienteFornecedor, nomeCliente, cpfCnpj, loteWS FROM PiniPedido WHERE CODEMPRESA='"+ SM0->M0_CODIGO +"' AND CODUSUARIO="+ codUsuario +" AND STATUS='A' AND TIPOPEDIDO<>'E' AND VALOR>0 ORDER BY IDPEDIDO"
	...
	While !EOF() //loop nos pedidos
		...
		*/                    
		...
		ELSE
			...
			cCartaoOperadora := JOBPINI->CARTAOOPERADORA
			cCartaoNumero := JOBPINI->CARTAONUMERO
			dCartaoValidade := IIF(EMPTY(JOBPINI->CARTAOVALIDADE), STOD(""), STOD(substr(JOBPINI->CARTAOVALIDADE,3,4)+substr(JOBPINI->CARTAOVALIDADE,1,2)+"01")) //MMyyyy
			cCartaoCodSeg := JOBPINI->CARTAOCODSEG
			cCartaoTitular := IIF(EMPTY(JOBPINI->CARTAOTITULAR), "NN "+ JOBPINI->NOSSONUMERO, ALLTRIM(EMPTY(JOBPINI->CARTAOTITULAR)))
			cDebitoBanco := JOBPINI->DEBITOBANCO
			cDebitoAgencia := JOBPINI->DEBITOAGENCIA
			cDebitoConta := JOBPINI->DEBITOCONTA
			cDebitoDAC := JOBPINI->DEBITODAC
			nDespesaBoleto := JOBPINI->DESPESABOLETO
			...
			aAdd(aHeader , cCartaoOperadora)
			aAdd(aHeader , cCartaoNumero)
			aAdd(aHeader , dCartaoValidade)
			aAdd(aHeader , cCartaoCodSeg)
			aAdd(aHeader , cCartaoTitular)
			aAdd(aHeader , cDebitoBanco)
			aAdd(aHeader , cDebitoAgencia)
			aAdd(aHeader , cDebitoConta)
			aAdd(aHeader , cDebitoDAC)
			aAdd(aHeader , nDespesaBoleto)
			...
			While !EOF() .and. nContCM <= 1//loop nos itens do pedido
				...
				*/               
				...
				//20130821 DAQUI
				cQuery := "SELECT G1_COD, G1_COMP, G1_QUANT, G1_PERC FROM "+ RETSQLNAME("SG1") +" WHERE G1_FILIAL='"+ XFILIAL("SG1") +"' AND G1_COD='"+ cProduto +"' AND D_E_L_E_T_<>'*' ORDER BY G1_COMP"
				DbUseArea( .T., "TOPCONN", TcGenQry(,,cQuery), "KITPROD", .T., .F. )
				DbSelectArea("KITPROD")
				dbGotop()
				if !EOF()
					bKit := .T.
					While !EOF()
						cProduto := KITPROD->G1_COMP
						cItem := strzero(nContItem,2)//PINIITEM->ITEM 
						AddItemPed()
						DbSelectArea("KITPROD")
						DbSkip()
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณupdPiniPedido บAutor  ณDanilo C S Pala บ Data ณ  20110621   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  |updReserva บAutor ณDanilo C S Pala     บ Data ณ  20110621   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  CarregarClienteบAutor  ณDanilo C S Pala บ Data ณ  20110621   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
If bInserir
	...
	RECLOCK("SA1",.T.) //insert
		...
		SA1->A1_INSCR := IIF(LEN(ALLTRIM(JOBPINI->CPFCNPJ))=14,JOBPINI->INSCRICAOESTADUAL,"")
		SA1->A1_PFISICA := IIF(LEN(ALLTRIM(JOBPINI->CPFCNPJ))<14,StrTran(JOBPINI->INSCRICAOESTADUAL,"RG ",""),"")
...
If bUpdate
	//20121030 nao atualizar se for cliente publicidade daqui
	cQuery = "select f2_cliente, count(*) as qtd from "+ RETSQLNAME("SF2") + " where f2_filial='"+xfilial("SA1")+"' and f2_emissao>=to_char((sysdate-(365*2)) ,'yyyyMMdd') and f2_Serie='PUB' and d_e_l_e_t_<>'*' and f2_cliente='"+ SUBSTR(cCodCliente,6) +"' and f2_loja='"+ SUBSTR(cCodCliente,7,2) +"' group by f2_cliente"
	DbUseArea( .T., "TOPCONN", TcGenQry(,,cQuery), "JOBPUB", .T., .F. )
	DbSelectArea("JOBPUB")
	dbGotop()           
	If eof() //SE NAO ENCONTROU ATUALIZA //20121030 
		//UPDATECliente
		DBSELECTAREA("SA1")
		DBSETORDER(1)
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณAddItemPedบAutor  ณDanilo C S Pala Data ณ  20130821         บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
Static Function AddItemPed()
				...
				if nfator ==2  //daqui 20111107
					if nContCM ==1
						...
						nValorTotal := round((nValorUnitario * nQtd),4) 
					else 
						nValorTotal := round(PINIITEM->VALORTOTAL - round((round(PINIITEM->VALORUNITARIO / nFator,4) * nQtd),4),4)
						nValorUnitario := round(nValorTotal/ nQtd,4)
					endif
				elseif bKit
					nValorUnitario := round(PINIITEM->VALORUNITARIO * (KITPROD->G1_PERC/100),2)
					nValorTotal := round(PINIITEM->VALORTOTAL * (KITPROD->G1_PERC/100),2)
					nQtd := PINIITEM->QTD * KITPROD->G1_QUANT
				else
					nValorUnitario := round(PINIITEM->VALORUNITARIO / nFator,4)
