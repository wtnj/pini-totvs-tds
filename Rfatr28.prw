...
User Function Rfatr28()        // incluido pelo assistente de conversao do AP5 IDE em 25/02/02
...
±±³Programa: RFATR28   ³Autor: Rosane Rodrigues       ³ Data:   16/05/00 ³ ±±
±±ÃÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´ ±±
±±³Descri‡ao: RELATORIO DE DOACOES / CORTESIAS                           ³ ±±
...
EndIf
cString  := "SC6"
cDesc1   := PADC("Este programa emite o relat¢rio das doacoes e ",70)
cDesc2   := PADC("cortesias por produto no per¡odo solicitado",70)
cDesc3   := " "
tamanho  := "M"
...
nLastKey := 0
nLin     := 80
titulo   := "Doacoes / Cortesias por Produto"
...
MHORA := TIME()
wnrel    := "RFATR28_" + SUBS(CUSUARIO,7,3)+SUBS(MHORA,1,2)+SUBS(MHORA,7,2)       //Nome Default do relatorio em Disco
...
While !eof() .and. sc6->c6_produto <= mv_par02
    ...
    If .NOT. "CORTESIA" $(F4_TEXTO) .AND. .NOT. "DOACAO" $(F4_TEXTO)
       DbSelectArea("SC6")
       DbSkip()
       Loop
    Endif
