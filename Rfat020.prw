...
±±³Programa: RFAT020   ³Autor: Solange Nalini         ³ Data:   26/03/98 ³ ±±
...
//	l:=6
	...
	@ l+4,055 PSAY CLIE_BAIR                         && bairro
	@ l+5,011 PSAY SUBS(CLIE_CEP,1,5)+'-'+SUBS(CLIE_CEP,6,3)   && cep do cliente
	@ l+5,023 PSAY CLIE_MUNI                         && cep do cliente
	@ l+5,065 PSAY CLIE_ESTA                       && fone do cliente
	@ l+6,011 PSAY 'CNPJ/CPF :'+CLIE_CGC                          && c.g.c.
	@ L+7,011 PSAY 'INSCR.EST.'+CLIE_INSC                         && inscricao estadual
	...
	ELSE
		...
		@ L+13,011 PSAY XENDC
		@ L+13,055 PSAY XBAIRROC
		@ L+14,011 PSAY SUBS(XCEPC,1,5)+'-'+SUBS(XCEPC,6,3)
		@ L+14,022 PSAY XCIDADEC
		@ L+14,050 PSAY XESTADOC
