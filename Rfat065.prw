...
User Function Rfat065()        // incluido pelo assistente de conversao do AP5 IDE em 25/02/02
...
±±³Programa: RFATR19   ³Autor: Rosane Rodrigues       ³ Data:   03/02/00 ³ ±±
±±ÃÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´ ±±
±±³Descri‡ao: RELATORIO DE N.F POR VENDEDOR                              ³ ±±
...
EndIf
cString  := "SE1"
cDesc1   := PADC("Este programa emite o relat¢rio das N.F. por Vendedor",70)
cDesc2   := PADC("com emissÆo no per¡odo solicitado.",70)
cDesc3   := " "
tamanho  := "M"
...
nLastKey := 0
nLin     := 80
titulo   := "N.F. por Vendedor/EmissÆo"
cCabec1  := "Vendedor Inicial : " + MV_PAR01 + SPACE(10) + "Vendedor Final : " + MV_PAR02 + SPACE(10) +;
            "EmissÆo Inicial : " + DTOC(MV_PAR03) + SPACE(10) + "EmissÆo Final : " + DTOC(MV_PAR04)
cCabec2  := " " 
