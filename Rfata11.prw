...
/*	aAdd( aCols, { 0, Space(4), 0, 0, stod(""), Space(15), Space(6),;
	...
	Space(6), Space(3), stod(""), 0, Space(3),stod(""),.F.} ) // Space(2),,.F.*/ //20040630
	aAdd( aCols, { Space(2), Space(4), 0, 0, stod(""), Space(15), Space(6),;
	Space(3), Space(4), Space(4), Space(2), stod(""), stod(""),;
	Space(6), Space(3), stod(""), 0, Space(3),stod(""),.F.} ) // Space(2),,.F.
