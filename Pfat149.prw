...
//ULTIMA ATUALIZACAO 20030926 POR DANILO C S PALA
...
SetPrvt("CINDEX,MVEND5,CKEY,_SALIAS,AREGS,I,J, mBase, mNomeCli, mCodCli, mLoja")
...
Do While !EOF()
	...
	mNomeVend:=""
	mDivVend :=""
	mBase 	 := SE3->E3_BASE //20030926
	mCodCli := SE3->E3_CODCLI //20030926
	mLoja	 := SE3->E3_LOJA //20030926
...
Replace Base 	 With mBase //20030926   
Replace CodCli	 With mCodCli //20030926   
Replace Loja	 With mLoja //20030926   
Replace NomeCLI  With mNOMECLI //20030926
MsUnlock()
Return
...
AADD(_aCampos,{"BASE","N",12,2})//20030926  
