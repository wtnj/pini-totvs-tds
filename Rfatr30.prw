...
User Function Rfatr30()        // incluido pelo assistente de conversao do AP5 IDE em 25/02/02
...
SetPrvt("_CIND,_CKEY,_CFILTRO,_MPROD,_MQTDE,_MTOTP")
SetPrvt("_MVAL,_MNUM,_MDESCR,_MCONT,_MOTIVO,_MHIST")
SetPrvt("_MPERC,_MDESP,_MNOTA,mhora")
