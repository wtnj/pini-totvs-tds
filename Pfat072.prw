...
±±³RDMAKE    ³PFAT072   ³ Autor ³ Gilberto A. Oliveira  ³ Data ³ 30.09.00 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descri‡„o ³Relatorio para acompanhamento das renovacoes/recuperacoes.  ³±±
...
MHORA      := TIME()
wnrel   := "PFAT072_" + SUBS(CUSUARIO,7,3)+SUBS(MHORA,1,2)+SUBS(MHORA,7,2)            // Nome Default do relatorio em Disco
cPerg   := "PF072"
