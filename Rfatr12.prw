...
cDesc2   := PADC("liberadas e nÆo faturadas por per¡odo - Especiais",70)
cDesc3   := " "
tamanho  := "M"
...
_nav     := SPACE(6)
nLin     := 80
titulo   := "Inser‡äes liberadas e nÆo faturadas - Especiais"
cCabec1  := " "
cCabec2  := " " 
...
if _mtot <> 0
   ...
   nLin := Cabec(titulo,cCabec1,cCabec2,nomeprog,tamanho,18) //Impressao do cabecalho
   nLin := nLin + 2
   @ nlin,0  PSAY "Cliente  Nome do Cliente                           Num.Av  Item   Produto    Ins/Qtde   Edi‡Æo   Dt.Circ.   Val.Inser‡ao   Cod.Mat."
   nlin := nLin + 1
   @ nlin,0  PSAY "-------  ----------------------------------------  ------  ----   --------   --------   ------   --------   ------------   --------"
Endif
