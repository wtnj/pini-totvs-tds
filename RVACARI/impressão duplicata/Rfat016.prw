...
//WHILE !Eof() .and. SD2->D2_FILIAL == xFilial("SD2") .and. SD2->D2_DOC >= MV_PAR01 .AND. SD2->D2_DOC <= MV_PAR02 .AND. SD2->D2_SERIE <= MV_PAR03   //- Thiago Lima 31/10/2013
...
//	IF (SE1->E1_SERIE<>'UNI' .AND. SE1->E1_SERIE<>'PUB'.AND. SE1->E1_SERIE<>'SEN') .OR. SE1->E1_SITUA=='2' 
	IF (SE1->E1_SERIE<>'21 ' .OR. SE1->E1_SITUA=='2') //- Thiago Lima 31/10/2013
		DBSELECTAREA("SD2")
		DBSKIP()
		LOOP
	ENDIF
