...
±±³Descri‡ao: Impressao de Etiquetas para Mala Direta.                   ³ ±±
...
±±ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿ ±±
±±³PFAT106E.PRX        ³ Gilberto A. de Oliveira Jr.  ³ Data:   16/04/00 ³ ±±
...
±±³Gilberto - 25.09.00 ³Despreza os registros que tenham situacao de nao ³ ±±
±±³                    ³recebimento de mailing no cadastro de destinata- ³ ±±
±±³                    ³rios.                                            ³ ±±
...
//³ mv_par08 Situa‡Æo...........: Baixados, Em Aberto, Ambas.               ³
...
If Found()
	#IFDEF WINDOWS
		MsgStop(OEMTOANSI("Codigo ja utilizado, informe codigo valido ou solicite manuten‡Æo no cad. Mailing"))
	#ELSE
		Alert("Codigo ja utilizado, informe codigo valido ou solicite manuten‡ao no cad. Mailing")
	#ENDIF
	Return
Endif
...
ELSE
	...
	IF !FOUND()
		#IFNDEF WINDOWS
			ALERT("Mailing nÆo cadastrado")
			ALERT("Entrar em contato com depto de Marketing")
		#ELSE
			MsgStop(OEMTOANSI("Mailing nÆo cadastrado"))
