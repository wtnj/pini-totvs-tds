...
#DEFINE MAXITEMC   050 //038 //20130313                               // Máxima de caracteres por linha de produtos/serviços
...
/*/
//Alterado por Danilo C S Pala em 20110721: frete
//Alterado por Danilo C S Pala em 20111118: imprimir o valor tributado, pois o outro esta errado.
//Alterado por Danilo C S Pala em 20130313: numero maximo de caracteres do produto mpresso por linha
...
For nZ := 1 To nLenDet
    ...
    Else
	    ...
	    nVUnit   := Val(oDet[nX]:_Prod:_vUnTrib:TEXT) //20111118 VOLTEI AO ORIGINAL ESTAVA ASSIM EM 20130510 Val(oDet[nX]:_Prod:_vUnCom:TEXT)
	EndIf
...
ElseIf cModFrete =="1"
	oDanfe:Say(382,247,"1-DESTINATARIO",oFont08:oFont) //20110721
ElseIf cModFrete =="2"
