...
User Function Rfatr30b()        // incluido pelo assistente de conversao do AP5 IDE em 25/02/02
...
cCabec2  := "Emissäes a partir de 01/11/2000"
cCancel  := "***** CANCELADO PELO OPERADOR *****"
m_pag    := 1               //Variavel que acumula numero da pagina
MHORA := TIME()
wnrel    := "RFATR30B_" + SUBS(CUSUARIO,7,3)+SUBS(MHORA,1,2)+SUBS(MHORA,7,2)       //Nome Default do relatorio em Disco
...
dbSelectArea("SE1")
** ACRESCENTADO O ULTIMO FILTRO(DT EMISSAO > 31/10/00)
_cInd    := CriaTrab(NIL,.F.)
